module github.com/furychain/fury
...
replace (
	...
	// go list -m -json github.com/furychain/wasmd@main | jq '.|"\(.Path) \(.Version)"' -r
	github.com/CosmWasm/wasmd => github.com/furychain/wasmd v0.30.1
	// go list -m -json github.com/furychain/wasmvm@main | jq '.|"\(.Path) \(.Version)"' -r
	github.com/CosmWasm/wasmvm => github.com/furychain/wasmvm v1.2.0
