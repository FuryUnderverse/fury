...
import (
	...
	_ "github.com/furychain/fury/doc/statik"
	...
	appconfig "github.com/furychain/fury/cmd/config"
)

const appName = "Furychain"
...
var (
	...
	// https://github.com/furychain/fury/blob/02a54d33ff2c064f3539ae12d75d027d9c665f05/x/wasm/internal/types/proposal.go#L28-L34
...
var (
	_ simapp.App              = (*FurychainApp)(nil)
	_ servertypes.Application = (*FurychainApp)(nil)
)

// FurychainApp extended ABCI application
...
// NewFurychainApp returns a reference to an initialized FurychainApp.
func NewFurychainApp(logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool,
	...
	appOpts servertypes.AppOptions, wasmOpts []wasm.Option, baseAppOptions ...func(*baseapp.BaseApp)) *FurychainApp {
...
func (app *FurychainApp) BlockedAddrs() map[string]bool {
...
func (app *FurychainApp) LegacyAmino() *codec.LegacyAmino {
...
func (app *FurychainApp) getSubspace(moduleName string) paramstypes.Subspace {
...
// API server.
func (app *FurychainApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *FurychainApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *FurychainApp) RegisterTendermintService(clientCtx client.Context) {
	tmservice.RegisterTendermintService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.interfaceRegistry)
}

func (app *FurychainApp) RegisterNodeService(clientCtx client.Context) {
...
func (app *FurychainApp) upgradeHandler() {
